from .serializers import ProductSerializer, WarehouseSerializer, ProductMaterialSerializer, MaterialSerializer
...
class WarehouseViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        product_materials = ProductMaterial.objects.filter(product__name=self.request.query_params.get('product_name'))
    ...
    def list(self, request, *args, **kwargs):
        ...
        for product in queryset:
            ...
            for product_material in product_materials:
                ...
                warehouses = Warehouse.objects.filter(material=product_material.material)
